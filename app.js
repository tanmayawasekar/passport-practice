...
// AWS.config.update({ region: 'us-east-1', cong accessKeyId: sesKeys.SES_KEY, secretAccessKey: sesKeys.ses_creds.SES_PASSWORD });

app.post("/sendemail", function (req, res) {
    AWS.config.loadFromPath(__dirname + '/sesKeys.json')
    // console.log(sesKeys.SES_KEY, sesKeys.SES_PASSWORD, "<----------------")
